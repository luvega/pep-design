...
| upstream assessment | [`manuscript/support/review_draft_benchmark_reference_value.md`](review_draft_benchmark_reference_value.md) |
...
| new artifact | [`benchmark/method_sources/method_landscape_watchlist_v0.9.csv`](../../benchmark/method_sources/method_landscape_watchlist_v0.9.csv) |
...
完整覆盖映射见 [`method_landscape_watchlist_v0.9.csv`](../../benchmark/method_sources/method_landscape_watchlist_v0.9.csv)。要点如下。
