...
- Added four project-local manuscript figure assets under `reports/assets/figures/` and recorded image-generation intent in `imagegen_prompt_record_v1.md`.
- Embedded four conceptual figures and four CSV-derived Markdown tables into `reports/benchmark_manuscript_outline_zh_v1.md`.
...
- Added `reports/supplementary_materials_reference_value_v1.1.md`, `reports/short_peptide_scoring_rationale_v1.1.md`, and `reports/cyclic_peptide_benchmark_supplement_v1.1.md`.
- Added `tables/supplementary_materials_action_matrix_v1.1.csv`, `tables/scoring_metric_rationale_matrix_v1.1.csv`, and `tables/method_landscape_patch_candidates_v1.1.csv`.
...
- Added separate Chinese and English Benchmark manuscript draft outlines in `reports/benchmark_manuscript_outline_zh_v1.md` and `reports/benchmark_manuscript_outline_en_v1.md`.
- Added `reports/benchmark_manuscript_sync_map_v1.csv` to keep bilingual section IDs, shared evidence artifacts, claim IDs, and next actions aligned.
- Added shared v1.0 support artifacts: `tables/candidate_method_classification_v1.csv`, `reports/benchmark_test_design_v1.md`, `benchmarks/input_sets/reference_dataset_sources_v1.csv`, `reports/benchmark_reference_bibliography_v1.md`, and `reports/benchmark_manuscript_todo_v1.csv`.
...
- Added current-plan routing to `reports/updated_plan_v0.9.md`, artifact roles, execution gates, claim boundaries, update order, validation commands, and git safety rules.
...
- Added `reports/updated_plan_v0.9.md` as the current authoritative plan, consolidating ARS review, Benchmark paper template alignment, v0.8 readiness evidence, and v0.9 review-driven method landscape coverage.
...
- Synthesized the read-only draft `G:\Downloads\Markdown笔记\王梁多肽综述草稿.md` into additive Benchmark framework supplements, building on `reports/review_draft_benchmark_reference_value.md`.
- Added `reports/review_synthesis_benchmark_framework_supplement.md` and `benchmarks/method_sources/method_landscape_watchlist_v0.9.csv` (paradigm/topology coverage map for ~22 review methods vs the 10 include methods).
...
- Added `reports/review_draft_benchmark_reference_value.md` to evaluate the read-only draft `G:\Downloads\Markdown笔记\王梁多肽综述草稿.md` for Benchmark representativeness, task taxonomy, target coverage, and claim boundaries.
...
- Added `dataset_supplement_schema_review_v0.8.csv`, `method_readiness_review_v0.8.csv`, `download_manifest_v0.8.csv`, and `reports/license_schema_input_contract_review_v0.8.md`.
...
- Added `reports/supervisor_skills_idea_evaluation.md`, `reports/benchmark_template_audit.md`, and `reports/benchmark_intro_logic_chain.md`.
