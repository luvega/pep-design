...
|:---|:---|:---|:---|
| `pepmlm.md` | method | sequence-conditioned peptide language model | include |
...
| `bindcraft.md` | method | AF2 backpropagation plus MPNN/PyRosetta binder pipeline | include |
| `pepflow.md` | method | full-atom multi-modal flow matching | watchlist |
| `boltzdesign1.md` | method | all-atom structure-prediction inversion | watchlist |
