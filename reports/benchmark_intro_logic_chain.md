...
| severity | gap |
|:---|:---|
| MAJOR | A Table 1 comparison against existing benchmarks/scoring resources is still needed. |
| MINOR | The limitation paragraph should cite benchmark/scoring/developability lessons from `tables/benchmark_literature_lessons.csv`. |
