...
1. 用 `tables/supplementary_materials_action_matrix_v1.1.csv` 逐条跟踪 6 份材料。
2. 用 `tables/scoring_metric_rationale_matrix_v1.1.csv` 固化短肽评分和环肽可开发性指标理由。
3. 用 `tables/method_landscape_patch_candidates_v1.1.csv` 记录新增方法线索，保持非 include 状态。
