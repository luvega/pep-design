...
| source_pin_evidence | `benchmark/method_sources/source_pin_audit_v0.5.csv` |
...
| checkpoint_manifest_status | 8 checkpoint files with sizes and md5 hashes recorded by API; selected future rows added to `benchmark/deployment/download_manifest_v0.8.csv` |
