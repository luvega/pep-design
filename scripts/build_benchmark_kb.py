...
CANDIDATE_METHODS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "year": "2026",
        "family": "flow matching for hetero-chiral peptide design",
        "design_modality": "full-atom L/D peptide generation with axial-vector chirality encoding",
        "input_requirement": "protein-peptide complex context and chirality constraints",
        "output_type": "hetero-chiral peptide structures/sequences",
        "peptide_type": "L/D and hetero-chiral peptides",
        "task": "D-peptide and hetero-chiral protein-peptide interaction design",
        "target_type": "protein-peptide complexes",
        ...
        "total_score": "21",
        "decision": "include",
        "reported_metrics": "chirality-aware structural and interaction metrics to extract",
        "datasets": "hetero-chiral protein-peptide complexes; verify release",
        ...
        "reproducibility_notes": "record stereochemistry encoding and any L-only fallback handling",
    },
    {
...
CONCEPTS = [
    {
        ...
        "methods": ["PepMLM", "SaLT&PepPr", "DiffPepBuilder", "RFdiffusion + ProteinMPNN"],
    },
    {
    ...
    },
    {
        ...
        "methods": ["DexDesign / OSPREY3", "D-Flow / PeptideDesign"],
    },
    {
